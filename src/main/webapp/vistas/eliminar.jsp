    				...
    				<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
					  ...
					  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
					    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					      ...
					      <li class="nav-item active">
					        <a class="nav-link" href="general">Reporte General<span class="sr-only"></span></a>
					      </li>
					    </ul>
					  </div>
				</nav>
...
<table class="table table-striped border text-center">
 ...
 <div class="card ">
						<div class="card-header bg-info text-white">
							<h1 class="text-center">Modificación de Datos</h1>
				 	</div>
				<div id="box">
  <main id="center">
 ...
 <tbody>
      ...
      <td><input type="text" class="form-control" name="numero" required placeholder="Ingresar Número de Empleado...."></td>
    </th>
 ...
 <center><input type="submit" class="btn btn-danger" value="ELIMINAR" ></center>
</main>
</div>
